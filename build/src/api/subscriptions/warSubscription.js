 ...
 */
function warSubscription(event, callback, filters) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const channelName = JSON.parse(yield (yield fetch(`https://api.politicsandwar.com/subscriptions/v1/subscribe/war/${event}?api_key=${this.apiKey}${linkFilter}`, {
            method: 'GET',
        })).text()).channel;
        ...
        channel.bind(`BULK_WAR_${event.toUpperCase()}`, function (data) {
            callback(data);
            return;
        });
        return channel;
