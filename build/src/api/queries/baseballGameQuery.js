...
function baseballGameQuery(params, query, paginator) {
  ...
  `, this.apiKey);
        ...
        return res.data.nations.data;
    });
}
exports.default = baseballGameQuery;
//# sourceMappingURL=baseballGameQuery.js.map