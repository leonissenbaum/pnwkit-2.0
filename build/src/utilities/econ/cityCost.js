 ...
 */
function cityCost(startingCity, endingCity, resourcePrices, UP, AUP, MP, MD, GSA) {
    let costs = {
        cityPrice: 0,
        resourcePrice: 0,
        lead: 0,
    ...
    for (let i = startingCity; i < endingCity; i++) {
        ...
        costs.cityPrice += formula - (0, getPercentage_1.default)(formula, (percentage + cityPercent));
    }
