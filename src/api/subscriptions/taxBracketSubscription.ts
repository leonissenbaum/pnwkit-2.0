 ...
 * @param {subscriptionFilters} filters Filter the tax brackets
 * @return {void}
 */
export default async function taxBracketSubscription(this: Kit, channel: string, event: string, callback: Function): Promise<void> {
