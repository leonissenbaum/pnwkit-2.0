 ...
 * @param {subscriptionFilters} filters Filter the baseball games
 * @return {void}
 */
export default async function baseballTeamSubscription(this: Kit, channel: string, event: string, callback: Function): Promise<void> {
