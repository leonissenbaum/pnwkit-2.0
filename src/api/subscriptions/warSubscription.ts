 ...
 * @param {subscriptionFilters} filters Filter the wars
 * @return {void}
 */
export default async function warSubscription(this: Kit, channel: string, event: string, callback: Function): Promise<void> {
